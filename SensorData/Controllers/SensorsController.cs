...
namespace SensorData.Controllers
{
    public class SensorsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ar1,Ar2,Ar3,H2o1,H2o2,H2o3,CalDateTime")] Sensor sensor)
        {
            if (id != sensor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SensorContext.Sensors'  is null.");
            }
            var sensor = await _context.Sensors.FindAsync(id);
            if (sensor != null)
            {
